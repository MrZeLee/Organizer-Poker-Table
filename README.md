...
## Usage
Download the [executable](https://github.com/MrZeLee/Organizer-Poker-Table/releases/latest/download/Table-Organizer.exe)

or

**(Better option while there's no GUI)** Install [AutoHotkey](https://www.autohotkey.com) and run [Table Organizer script](Table-Organizer.ahk), modify defined variables to your taste.
### Be carefull
